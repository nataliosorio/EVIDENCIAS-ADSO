function edad(pfechaNac, pfechaHoy){
    ...
    edadd=  fechaHoy.getFullYear() - fechaNac.getFullYear();
    mesDifer = fechaHoy.getMonth() - fechaNac.getMonth();
...
function edadPersonas() {
    ...
    let fechaNac1 = new Date(document.getElementById('fecha-nac1').value);
    let fechaNac2 = new Date(document.getElementById('fecha-nac2').value);
    let fechaNac3 = new Date(document.getElementById('fecha-nac3').value);
